...
export const projects: Project[] = [
  ...
  },
  {
    ...
    overview: "Developed embedded C firmware for an STM32-based RC car using a course-provided PCB. Implemented a UART Bluetooth command interface that translated wireless commands into real-time vehicle control. Integrated PWM motor-speed control, servo steering, LED outputs, and ultrasonic distance sensing. Debugged communication and peripheral-integration issues to achieve reliable end-to-end operation. The PCB was provided for the course; my primary contribution was firmware development, Bluetooth communication, peripheral integration, and debugging rather than PCB design.",
