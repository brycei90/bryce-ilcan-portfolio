    ...
    <main>
      ...
      <section className="section-shell case-layout">
        ...
        <div className="case-main">
          ...
          <section className="case-section"><h2>My contribution</h2><p>{["uav-cell-monitoring-board", "custom-uav-esc"].includes(project.slug) ? "My responsibilities spanned technical development, integration, and team leadership." : "My responsibilities spanned technical development and integration."}</p><div className="bullet-grid">{project.contributions.map((item) => <div className="bullet-item" key={item}>{item}</div>)}</div></section>
